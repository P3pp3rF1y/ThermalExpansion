...
/*
		...
		furnace = addAchievement("cofh.te.furnace", "thermalexpansion.furnace", -2, 2, BlockMachine.machineFurnace, machineFrame);
		...
		// Tool Achievements
		wrench = addAchievement("cofh.te.wrench", "thermalexpansion.wrench", -2, -1, TFItems.itemWrench.toolWrench, base).registerStat();

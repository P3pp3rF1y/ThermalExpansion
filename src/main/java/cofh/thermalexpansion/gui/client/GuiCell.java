...
public class GuiCell extends GuiTEBase {
	...
	public void initGui() {
		...
		addTab(new TabTutorial(this,
				StringHelper.tutorialTabRedstone() + "\n\n" + StringHelper.tutorialTabConfigurationEnergy()));
		if (myTile.enableSecurity() && myTile.isSecured()) {
			addTab(new TabSecurity(this, myTile, playerName));
		}

		decRecv = new ElementButton(this, 28, 56, "DecRecv", 176, 0, 176, 14, 176, 28, 14, 14, TEX_PATH)
				.setToolTipLocalized(true);
		incRecv = new ElementButton(this, 44, 56, "IncRecv", 190, 0, 190, 14, 190, 28, 14, 14, TEX_PATH)
				.setToolTipLocalized(true);
		decSend = new ElementButton(this, 118, 56, "DecSend", 176, 0, 176, 14, 176, 28, 14, 14, TEX_PATH)
				.setToolTipLocalized(true);
		incSend = new ElementButton(this, 134, 56, "IncSend", 190, 0, 190, 14, 190, 28, 14, 14, TEX_PATH)
				.setToolTipLocalized(true);
	...
	protected void updateElementInformation() {
		...
		if (myTile.energyReceive < myTile.type.getMaxReceive()) {
			incRecv.setActive();
		...
		if (myTile.energySend < myTile.type.getMaxSend()) {
			incSend.setActive();
